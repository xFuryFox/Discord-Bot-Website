...
export default function AwardApp({ Component, pageProps }) {
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=1102009908578238534&permissions=277028603968&scope=applications.commands%20bot",
    },
    {
      link: true,
      name: "Vote",
