        ...
        <div className="pt-10 mx-auto">
          <div className="lg:grid lg:grid-cols-6 gap-20">
            <div className="col-span-3">
              ...
              <Menu as="div" className="relative mt-3 inline-block text-left">
                <div>
                  ...
                  <a href="https://top.gg/bot/1102009908578238534">
                    <img
                      src={
                        "https://top.gg/api/widget/servers/1102009908578238534.svg"
                      }
                    />
                  </a>
                  <div className="py-1"></div>
                  <a href="https://top.gg/bot/1102009908578238534">
                    <img
                      src={
                        "https://top.gg/api/widget/upvotes/1102009908578238534.svg"
                      }
                    />
                  </a>
                  <div className="py-1"></div>
                  <a href="https://top.gg/bot/1102009908578238534">
                    <img
                      src={
                        "https://top.gg/api/widget/owner/1102009908578238534.svg"
                      }
                    />
                  </a>
                </div>
            ...
            <div className="col-span-1">
              ...
              <div>
                <a
                  href="https://discord.gg/bvwGydeQRA"
                  target="_blank"
            ...
            <div className="col-span-1">
              ...
              <div>
                <Link href="https://discord.gg/bvwGydeQRA">
                  <a className="text-white/50 hover:text-white hover:underline transform duration-200">
              ...
              <div>
                <Link href="https://github.com/xfuryfox/">
                  <a className="text-white/50 hover:text-white hover:underline transform duration-200">
              ...
              <div>
                <Link href="https://youtube.com/@FuryFox_">
                  <a className="text-white/50 hover:text-white hover:underline transform duration-200">
          ...
          <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
            ...
            <div className="hidden md:flex items-center justify-center">
              <p className={"text-xs text-green-400"}>Bot Online</p>
            </div>
